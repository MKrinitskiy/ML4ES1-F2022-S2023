...
[Здесь](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/master/leaderboard_2semester.md) уже сейчас можно ознакомиться с отметками об автозачетах, допуске к зачету и зачетах.

[Здесь](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/master/term2_exam.md) уже сейчас можно ознакомиться со списком вопросов к зачету за второй семестр.
...
| ----- | ---- | ----- | ------- |
|  |  | **I семестр** |  |
| Лекция 1 | 20.09.2022 | Вводная лекция. Машинное обучение в науках о Земле. | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect01)<br>[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect01/) |
| Лекция 2 | 27.09.2022 | Искусственный интеллект, машинное обучение и глубокое обучение<br />Основные понятия и термины. | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect02)<br/>[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect02/) |
| Лекция 3 | 04.10.2022 | Технические средства анализа данных | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect03)<br/>[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect03) |
| Лекция 4 | 11.10.2022 | Вероятностная постановка задачи регрессии МО.<br />Метод максимального правдоподобия.<br />Линейная регрессия как метод МО. | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect04)<br/>[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect04) |
...
| Лекция №5 | 18.10.2022 | Общий подход решения задач машинного обучения ("Обучение с учителем")<br />Признаковое описание объектов/событий. | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect05)<br/>[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect05) |
...
| Лекция №6 | 01.11.2022 | Подход решения задач машинного обучения ("Обучение с учителем") - подробно (часть 1) | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect06)<br />[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect06) |
...
| Лекция №8 | 15.11.2022 | Оценка качества моделей МО на примере линейной регрессии. | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect08)<br />[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect08) |
| Лекция №9 | 22.11.2022 | Неопределенность в задачах машинного обучения. Виды неопределенностей. | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect09)<br />[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect09) |
...
| Лекция №10 | 29.11.2022 | Оценка неопределенностей меры качества, параметров модели, целевой переменной с применением подхода Bootstrap | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect10)<br />[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect09) |
...
| Лекция №11 | 06.12.2022 | Оптимизация параметрических моделей МО.<br />Семейства методов оптимизации. Градиентная оптимизация. | [видеозапись](https://ml4es.ru/links/ML4ES-2022-Lect11)<br />[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect11) |
|  |  | 2-й семестр |  |
...
| Лекция 20 | 18.04.2023 | Ансамбли моделей:<br />Bagging и Random Forests (случайные леса) (повторение)<br />Подхоод бустинга, AdaBoost, градиентный бустинг. | [видеозапись](https://ml4es.ru/links/ML4ES1-2023-04-18-Lect20)<br />[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect20) |
| Лекция 21 | 25.04.2023 | Обобщенные линейные модели.<br />Обобщенные аддитивные модели.<br />Многослойный перцептрон. | [видеозапись](https://ml4es.ru/links/ML4ES1-2023-04-25-Lect21)<br />[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect21) |
