...
| Лекция №10 | 29.11.2022 | Оценка неопределенностей меры качества, параметров модели, целевой переменной с применением подхода Bootstrap | [видеозапись](https://ml4es.ru/links/ML4ES1-2022-Lect10)<br />[материалы занятия](https://github.com/MKrinitskiy/ML4ES1-F2022-S2023/blob/main/Lect10) |
